<h1 align="center"> 🚀 Game Google | Vanilla </h1>

## ✍️ Descrição
Exemplificação de aplicação de jogo do google offline usando vanilla ou Javascript puro
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/game-google-vanilla.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/NWBMgew) 
